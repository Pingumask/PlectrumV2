...
rest.put(Routes.applicationCommands(CLIENT_ID), { body: commands })
	.then(() =>
		console.log(`${commands.size} Commandes globales répertoriées.`)
	)
	.catch(console.error);

rest.put(Routes.applicationGuildCommands(CLIENT_ID, BETA_GUILD_ID), {
	body: betaCommands,
})
	.then(() =>
		console.log(`${betaCommands.size} Commandes BETA répertoriées.`)
	)
	.catch(console.error);
